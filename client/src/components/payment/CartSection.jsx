    ...
    <div className="public-shopping-cart-section section-padding">
      <div className="container">
        <div className="student-title">
          <h2>Giỏ hàng của tôi ({isAddCart ? 1 : 0}) </h2>
        </div>
        {isAddCart ? (
          <div className="row">
          ...
          <div className="d-flex flex-column align-items-center justify-content-center">
            <img
              src="https://bizweb.dktcdn.net/100/460/034/themes/869044/assets/cart_icon.png?1700543302271"
              alt="empty"
            ...
            >
              Bạn tham khảo thêm các sản phẩm ở trang mua sắm nhé!
            </div>
