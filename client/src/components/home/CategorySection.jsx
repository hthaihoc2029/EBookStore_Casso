            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
              <a className="d-block" href="category.html">
                <div className="category-content  badge-color-2">
                  ...
                  <div className="category-content-right">
                    <h4>Truyện ngắn - Tản văn</h4>
                    <span>2,822 Books</span>
                  </div>
                </div>
              </a>
            </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
              <a className="d-block" href="category.html">
                <div className="category-content  badge-color-4">
                  ...
                  <div className="category-content-right">
                    <h4>Tiểu sử - Hồi ký</h4>
                    <span>2,600 Books</span>
                  </div>
                </div>
              </a>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
              <a className="d-block" href="category.html">
                <div className="category-content  badge-color-2">
                  ...
                  <div className="category-content-right">
                    <h4>Rèn luyện trí tuệ</h4>
                    <span>1,678 Books</span>
                  </div>
                </div>
              </a>
            </div>
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
              <a className="d-block" href="category.html">
                <div className="category-content  badge-color-3">
                  ...
                  <div className="category-content-right">
                    <h4>Sách giáo khoa - Sách tham khảo</h4>
                    <span>959 Books</span>
                  </div>
                </div>
              </a>
