                        ...
                        <div className="checkbox-field">
                          <ul>
                            ...
                            <li>
                              ...
                              Tiết kiệm chi phí: Ebook thường rẻ hơn sách in, có
                              thể tìm thấy nhiều ebook miễn phí hoặc giá rẻ trực
                              tuyến.
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="checkbox-field">
                          <ul>
                            <li>
                              ...
                              Có thể tùy chỉnh: Hầu hết các trình đọc ebook đều
                              cho phép bạn điều chỉnh phông chữ, kích thước chữ,
                              khoảng cách dòng và độ sáng màn hình để có trải
                              nghiệm đọc thoải mái nhất.
                            </li>
                            <li>
                              <svg
                                width={24}
                            ...
                            <li>
                              ...
                              Ebook không yêu cầu sử dụng giấy, giúp bảo vệ môi
                              trường.
                            </li>
                          </ul>
                        </div>
                  ...
                  <div className="profile-wrap course-instructor">
                    <div className="profile-left">
                      ...
                      <div className="profile-data">
                        ...
                        <p>
                          Alex Rovira sinh năm 1969 tại Barcelona, Tây Ban Nha.
                          Tốt nghiệp MBA tại ESADE, Alex trở thành một nhà đào
                          tạo tại các hội thảo về Đổi mới, Quản lý Thay đổi,
                          Quản lý Nhân tài, Quản lý Con người và Tư duy Sáng tạo
                          cho các lãnh đạo cấp cao của các công ty hay các tổ
                          chức phi chính phủ. Sách của ông xuất bản nhanh chóng
                          có mặt trong top sách bán chạy nhất và được dịch ra
                          nhiều ngôn ngữ, bán hàng triệu bản trên thế giới....{" "}
                          <a href="#">Read more</a>
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="profile-wrap course-instructor">
                    <div className="profile-left">
                      ...
                      <div className="profile-data">
                        ...
                        <p>
                          Đồng sáng lập công ty Salvetti & Llombart, với 40 cộng
                          sự hàng đầu ở Barcelona, Tây Ban Nha - chuyên nghiên
                          cứu thị trường, tư vấn cho các tập đoàn đa quốc gia
                          khổng lồ. Alex Rovira là tác giả cuốn The Inner
                          Compass và Fernando Trías de Bes là đồng tác giả cuốn
                          Lateral Marketing với chuyên gia tiếp thị hàng đầu thế
              ...
              <div className="course-right-sidebar">
                ...
                <div className="course-right-sidebar-row">
                  <div className="course-includes-wrap">
                    <h4 className="course-sidebar-title">Cuốn sách bao gồm</h4>
                    <ul>
                      <li>
                        <a href="#">
                          <svg
